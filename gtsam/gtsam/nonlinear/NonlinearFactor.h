...
protected:
  ...
  int constraintFactorType_; // 0: none, 1: equality, 2: inequality
...
public:
  ...
  NonlinearFactor() : isConstraintFactor_(false), constraintFactorType_(0) {}
  ...
  NonlinearFactor(const CONTAINER& keys) :
    Base(keys), isConstraintFactor_(false), constraintFactorType_(0) {}
